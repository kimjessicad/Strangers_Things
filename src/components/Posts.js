      ...
      {!activeSearch ? (
            ...
            <div key={e._id} className="post">
              ...
              <div className="postRightSide">
                ...
                <span className="postRightLocationDeliver">
                  ...
                  {e.willDeliver ? (
                    <p className="willDeliver"> ✅ Will deliver </p>
                  ) : null}
                </span>

                {e.isAuthor ? (
                  <button id={`${e._id}`} onClick={handleDelete}>
                    Delete
                  </button>
                ) : isLoggedIn ? (
                  <MessageForm postId={e._id} />
                ) : null}
              </div>
            </div>
          ))
        ...
        <>
          <div className="searchButtonContainer">
            <button id="clearSearchButton" onClick={handleClickResetSearch}>
              Clear Search
            </button>
          </div>
          {searchMatches.map((e) => (
